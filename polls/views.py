...
def poll_detail(request, poll_id):
    ...
    if not poll.active and request.user.has_perm('polls.add_poll'):
...
def poll_vote(request, poll_id):
    ...
    if not poll.user_can_vote(request.user):
        messages.error(
            request, "You already voted", extra_tags='alert alert-warning alert-dismissible fade show')
        return redirect("polls:list")
    ...
    if choice_id:
        ...
        print(vote)
        messages.success(
            request, "Voted successfully", extra_tags='alert alert-success alert-dismissible fade show')
        return redirect("polls:list")
    else:
        messages.error(
